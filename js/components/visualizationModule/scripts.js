...
$("#visualSideNavFilter").click(function () {
  $(this).parent('.sideNavHead').toggleClass("filterOpened");
});

// Side nav general
$("#visualSideNavFilterBtn .sideNavFilterBtn").click(function () {
...
$("#visualFullScreenBtn").click(function () {
  if ($(this).hasClass('active')) {
    $(this).toggleClass('active');
    $('#visualContainer').toggleClass('fullScreen');
    closeFullscreen();
  } else {
    $(this).toggleClass('active');
    $('#visualContainer').toggleClass('fullScreen');
